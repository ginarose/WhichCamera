$(document).ready(function(){
  ...
  $('#find-user').click(function() {
  	...
  	//formats it in the flickr url needed for grabbing data
  		var userinfo = "https://api.flickr.com/services/rest/?method=flickr.urls.lookupUser&api_key=LALALAAPI&url=www.flickr.com%2Fphotos%2F"+usernameinput+"%2F&format=json&jsoncallback=?";
  		...
  		$.ajax({
				...
				success:function(data){
					...
					$('#testing-output').text("Your username is "+displayname+" and your flickrID is "+flickrID+"!");
					}
		});
